...
- The diagnosis is done and the question shifts to "so what do we do?"
...
[Chosen option + the one-line reason]

## Options considered
| Option | The bet | Why distinct |
|---|---|---|
...
## Recommended option
- **Why it wins:** [the criteria it leads on]
- **Trade-off accepted:** [what we give up]
- **Must be true:** [key assumptions]
- **Watch for:** [signals to revisit the choice]
```
